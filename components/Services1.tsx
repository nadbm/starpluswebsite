        ...
        <>
            <section className="bg-white">
                <div className="container px-6 py-10 mx-auto">
                    <h1 className="text-2xl font-semibold text-center text-gray-800 capitalize lg:text-3xl ">explore
                        our <br/> awesome <span className="text-blue-500">Components</span></h1>

                    <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-16 md:grid-cols-2 xl:grid-cols-3">
                        <div
                            className="flex flex-col items-center p-6 space-y-3 text-center bg-gray-100 rounded-xl ">
                <span
                    className="inline-block p-3 text-blue-500 bg-blue-100 rounded-full  ">
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="none" viewBox="0 0 24 24"
                        ...
                        <path stroke-linejoin="round" stroke-width="2"
                            ...
                            <h1 className="text-xl font-semibold text-gray-700 capitalize ">Copy & paste
                                components</h1>
                ...
                <span
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="none" viewBox="0 0 24 24"
                        ...
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <h1 className="text-xl font-semibold text-gray-700 capitalize ">Zero
                                Configuration</h1>
                ...
                <span
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="none" viewBox="0 0 24 24"
                        ...
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <h1 className="text-xl font-semibold text-gray-700 capitalize">Simple &
                                clean designs</h1>
