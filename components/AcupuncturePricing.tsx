...
export default function AcupuncturePricing() {
    const t = useTranslations('acupuncture.pricing');
        ...
        <section className="py-20 lg:py-28 bg-gray-50">
            <div className="container mx-auto px-4">
                <div className="max-w-5xl mx-auto text-center">
                    <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-8 sm:mb-12 tracking-tight">
                        {t('title')}
                    </h2>
                    
                    <div className="bg-white rounded-3xl p-12 lg:p-16 shadow-2xl border-t-8 border-brand">
                        ...
                        <div className="bg-white rounded-2xl p-8 mb-8">
                            ...
                            <div className="grid sm:grid-cols-1 gap-4">
                                {[0, 1, 2, 3].map((index) => (
                                    <div key={index} className="flex items-start bg-gray-50 rounded-lg p-4 shadow-sm border border-gray-200">
