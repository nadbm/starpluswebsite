                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="bg-brand rounded-3xl overflow-hidden shadow-xl">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                            ...
                            <div className="relative lg:h-full p-8 lg:p-0">
                                ...
                                <div className="block lg:hidden">
                                    <div className="relative mx-auto w-64 h-64 md:w-80 md:h-80">
                                        <div
                                            className="absolute inset-0 bg-white/20 rounded-full -m-4 blur-2xl"></div>
                                        <img
                                            src="/team/sunqi.png"
                                            alt="Qi Meng Sun - Professional Massage Therapist"
                            ...
                            {/* Text Content */}
                            <div className="p-8 lg:p-12 lg:pl-8 bg-white">
                                <h2 className="text-4xl font-bold xx:text-2xl sm:text-3xl lg:text-4xl mb-6 text-center lg:text-left">
                                    Qi Meng Sun
                                </h2>
